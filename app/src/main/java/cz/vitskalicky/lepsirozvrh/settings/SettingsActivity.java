...
public class SettingsActivity extends BaseActivity implements Utils.RecreateWithAnimationActivity {
    ...
    private void handleIntent(Intent intent){
        if (!intent.getBooleanExtra("ignore",false)){
            ...
            if (dataString != null){
                String data = "";
                if (dataString.startsWith("https://vitskalicky.github.io/lepsi-rozvrh/motiv-info") || dataString.startsWith("https://vitskalicky.gitlab.io/lepsi-rozvrh/motiv-info")){
